  ...
  return (
    ...
    >
      <div className="container relative">
        ...
        <div className="flex flex-col mt-[160px] md:max-w-[400px] xl:max-w-[700px] xxl:max-w-[800px] ml-auto">
          ...
          <ul className="grid grid-cols-1 gap-y-10 gap-x-4 sm:grid-cols-2">
            <li className="flex gap-[20px] items-center">
              <MdOutlineSpeed className="w-[70px] h-[70px] text-grey bg-white p-[10px] rounded-full" />
              <p className="bg-white rounded-full p-[20px] w-[250px] text-center">
                speed and performance
              </p>
            </li>
            <li className="flex gap-[20px] items-center">
              <TbSailboat className="w-[70px] h-[70px] text-grey bg-white p-[10px] rounded-full" />
              <p className="bg-white rounded-full p-[20px] w-[250px] text-center">
                size and capacity
              </p>
            </li>
            <li className="flex gap-[20px] items-center">
              <AiOutlineSafety className="w-[70px] h-[70px] text-grey bg-white p-[10px] rounded-full" />
              <p className="bg-white rounded-full p-[20px] w-[250px] text-center">
                safety and reliability
              </p>
            </li>
            <li className="flex gap-[20px] items-center">
              <GiShipWheel className="w-[70px] h-[70px] text-grey bg-white p-[10px] rounded-full" />
              <p className="bg-white rounded-full p-[20px] w-[250px] text-center">
